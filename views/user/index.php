...
<div class="card mb-3">
    ...
    <div class="row">
      ...
      <div class="col-lg-6 text-end">
        ...
        if(isset($menuaccess_c) && $menuaccess_c->create_crud == 1){
          ?>
          <?= Html::a('Create User', ['create'], ['class' => 'btn btn-primary btn-sm']) ?>
          <?php
        }
        ?>
      </div>
  ...
  <div class="card-body">
    ...
    <div class="tbl-user-index table-responsive">
        ...
        'columns' => [
          ...
          [
            ...
            'value' => function ($model) {
              $locationNames = ArrayHelper::getColumn($model->locations, 'company_name');
              return implode(', ', $locationNames);
            },
            'filter' => \yii\helpers\Html::activeTextInput($searchModel, 'locationNames', ['class' => 'form-control']),
            'enableSorting' => true,
          ],
          [
            'attribute' => 'status',
            ...
            'filter' => Html::activeDropDownList($searchModel, 'status', [1=>"Active",2=>"Inactive"],['class'=>'form-select','prompt' => 'Select']),
          ],
          //'crt_by',
          //'mod_by',
          //'crt_time',
