...
/** @var app\models\TblExpenseCategorySearch $searchModel */
      ...
      <div class="col-lg-6 text-end">
        ...
        <?php
          if(isset($menuaccess) && $menuaccess->create_crud == 1){
            ?>
            <?= Html::a('Create Expense Category', ['create'], ['class' => 'btn btn-primary btn-sm']) ?>
            <?php
          }
         ?>
...
<div class="tbl-expense-category-index table-responsive">
        ...
        'columns' => [
            ...
            [
              ...
              'urlCreator' => function ($action, $model, $key, $index) {
                if ($action === 'edit') {
                  $url ='index.php?r=expense-category/update&id='.$model->id;
                  return $url;
                }
                if ($action === 'view') {
                  $url ='index.php?r=expense-category/view&id='.$model->id;
                  return $url;
                }
                if ($action === 'delete') {
                  $url ='index.php?r=expense-category/delete&id='.$model->id;
                  return $url;
                }
              }
            ],
            ...
            // [
            //     'class' => ActionColumn::className(),
            //     'urlCreator' => function ($action, TblExpenseCategory $model, $key, $index, $column) {
