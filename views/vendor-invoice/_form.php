  ...
  <div class="card shadow rounded mt-2">
    ...
    <div class="card-body p-3">
      ...
      if (!$model->isNewRecord) {
        ...
        $getdocs = \app\models\TblVendorInvoiceFile::find()
        ->where(['fk_vendor_invoice_id' => $model->id, 'status' => 1])
        ->all();
        ...
        if (!empty($getdocs)) {
          ...
          foreach ($getdocs as $doc) {
            ...
            $fileUrl = Yii::$app->request->baseUrl . '/vendor-invoices/' . $doc->invoice_file;
            $ext = strtolower(pathinfo($doc->invoice_file, PATHINFO_EXTENSION));
...
if(isset($getproducts) && count($getproducts) > 0){
  foreach($getproducts as $gp){
   ...
   $productinternal_sku = htmlspecialchars(
...
function calculatetotalwithtaxes(){
  ...
  $(".delete-button").click(function() {
    ...
    if (confirm("Are you sure you want to delete this image?")) {
      ...
      $.post('index.php?r=vendor-invoice/delpics', { del_id: imageId }, function(response) {
...
$this->registerJs($register_js_var);
  ...
  $(document).on("click",".img_open_popup",function(e){
    ...
    document.addEventListener('click', function (e) {
      ...
      if (type === 'pdf') {
        html += `<iframe src="${url}" style="width:100%; height:85vh;" frameborder="0"></iframe>`;
      } else {
