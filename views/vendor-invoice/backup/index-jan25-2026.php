...
$paymentStatusArr = [
    TblVendorInvoice::STATUS_PAID => 'Paid',
    TblVendorInvoice::STATUS_PARTIALLY_PAID => 'Partially Paid',
    TblVendorInvoice::STATUS_UNPAID => 'Unpaid'
];
?>
<div class="card mb-3">
  ...
  <div class="card-body">
    <div class="alert alert-outline-danger d-flex align-items-center" role="alert">
      <span class="fas fa-exclamation-circle text-danger fs-5 me-3"></span>
      <p class="mb-0 flex-1">This module is under Maintenance. Some data might be lost during creation or updation.</p>
