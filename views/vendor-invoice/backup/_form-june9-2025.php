...
$allporders = TblPurchaseOrder::find()->where(['status'=>1])->orderBy(['crt_by'=>SORT_DESC])->all();
                                              ...
                                              if(isset($getproducts) && count($getproducts) > 0){
                                                foreach($getproducts as $gp){
                                                  if($gi->fk_product_id != "" && $gi->fk_product_id == $gp->id){
                                                      echo '<option value="'.$gp->id.'" selected="selected">'.$gp->name.' ['.$gp->sku.']</option>';
                                                  }else{
                                                      echo '<option value="'.$gp->id.'">'.$gp->name.' ['.$gp->sku.']</option>';
                                                  }
                                                }
                                              }
                                           ?>
