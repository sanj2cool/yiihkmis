...
<div class="tbl-vendor-invoice-form">
  ...
  <div class="card shadow rounded mt-4">
    ...
    <div class="card-body p-3">
      <div class="row">
        <div class="col-lg-2">
          <?= $form->field($model, 'vendor_invoice_number')->textInput(['maxlength' => true]) ?>
        </div>
        <div class="col-lg-4">
        ...
        if(isset($getitems) && count($getitems) > 0){
          ...
          foreach($getitems as $gi){
            ...
            if($receiving_count == 0){
                $show_receving = '<div class="mt-1">
                    <input type="checkbox" name="product_receiving_'.$i.'" value="1" checked/> Create Receiving
                </div>';
            }
            if($i == 0){
              ?>
