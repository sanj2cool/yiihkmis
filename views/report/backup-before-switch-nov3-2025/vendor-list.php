...
<div class="card">
	...
	<div class="card-body border-top">
        <form name="frm_reservation" id="" action="<?= Yii::$app->urlManager->createUrl(['report/vendor-list']) ?>" method="post" autocomplete="off">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-control" id="terms" name="terms" required="required">
            ...
            <table id="customer-list" class="display table table-hover table-bordered" data-page-length="20">
                ...
                <tbody>
                    ...
                    if(isset($from_date) && isset($to_date) && isset($terms) && isset($crt_by)){
                        ...
                        $model = TblVendor::find()->where('status != 0')->orderBy(['id'=>SORT_DESC])->all();
                    }
                    ...
                    foreach($model as $m){
                        ...
                        echo '<tr>
                        <td><a href="'.Url::to(['vendor/update','id'=>$m->id]).'" title="View" target="_blank">View</a></td>
