...
<?php
  $this->registerJs("
    $('#tblbinlocations-area').mask('S',{placeholder:'_'});
    $('#tblbinlocations-row,#tblbinlocations-bay,#tblbinlocations-level,#tblbinlocations-position').mask('00',{placeholder:'__'});
  ");
 ?>
