...
/** @var app\models\TblBinLocationsSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Bin Locations';
  ...
  <div class="card-header pt-3 pb-2">
    <div class="row">
      ...
      <div class="col-lg-6 text-end">
        ...
        <?= Html::a('Create Bin Location', ['create'], ['class' => 'btn btn-primary btn-sm']) ?>
...
<div class="tbl-bin-locations-index table-responsive">
        ...
        'columns' => [
            ...
            [
              ...
              'urlCreator' => function ($action, $model, $key, $index) {
                if ($action === 'edit') {
                  $url ='index.php?r=bin-locations/update&id='.$model->id;
                  return $url;
                }
                if ($action === 'view') {
                  $url ='index.php?r=bin-locations/view&id='.$model->id;
                  return $url;
                }
                if ($action === 'delete') {
                  $url ='index.php?r=bin-locations/delete&id='.$model->id;
                  return $url;
                }
              }
            ],
            ...
            // [
            //     'class' => ActionColumn::className(),
            //     'urlCreator' => function ($action, TblBinLocations $model, $key, $index, $column) {
