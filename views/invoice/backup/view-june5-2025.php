          ...
          <div class="comments-totals">
            ...
            <div class="align-text-right">
              ...
              if($model->hst == 11){
                ...
                ?>
                <p style="margin-bottom:0px;"><strong>GST (5%):</strong> $<?=number_format($five_tax,2,'.',',')?></p>
                <p style="margin-bottom:0px;"><strong>QST (9.975%):</strong> $<?=number_format($quebec_tax,2,'.',',')?></p>
                <?php
              }else{
                ?>
                <p style="margin-bottom:0px;"><strong><?=$tax_desc?> (<?=$hst?>):</strong> $<?=$model->hst_amount?></p>
                <?php
              }
               ?>
              <p style="margin-bottom:0px;"><strong>Total Amount:</strong> $<?=$model->total_amount?></p>
              <p style="margin-bottom:0px;"><strong>Amount Received:</strong> $<?=number_format($amount_received,2,'.',',')?></p>
