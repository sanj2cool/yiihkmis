            ...
            if($i == 0){
              ...
              <div class="row g-1">
                ...
                <div class="col-lg-2 mb-2">
                  ...
                  <input type="text" name="desc[]" id="desc_<?=$i?>" value="<?=Html::encode($gi->description)?>" placeholder="Description" required="required" class="form-control">
                </div>
