...
$this->title = "#".$model->estimate_number;
    ...
    <div class="card-body p-3">
      <div class="row">
        ...
        <div class="col-lg-9 text-end">
          ...
          <button id="print_invoice" class="btn btn-info btn-sm"><i class="fas fa-print"></i> Print Estimate</button>
          <?= Html::a('<i class="fas fa-envelope"></i> Send Estimate', ['send-estimate', 'id' => $model->id], ['class' => 'btn btn-success btn-sm']) ?>
          <?php
      ...
      <div class="comments-totals">
        ...
        <div class="align-text-right">
          ...
          if($model->hst == 11){
            ...
            ?>
            <p style="margin-bottom:0px;"><strong>GST (5%) on $<?=number_format($model->subtotal,2,'.','')?>:</strong> $<?=number_format($five_tax,2,'.',',')?></p>
            <p style="margin-bottom:0px;"><strong>QST (9.975%) on $<?=number_format($model->subtotal,2,'.','')?>:</strong> $<?=number_format($quebec_tax,2,'.',',')?></p>
            <?php
          }else{
            ?>
            <p style="margin-bottom:0px;"><strong><?=$tax_desc?> (<?=$hst?>) on $<?=number_format($model->subtotal,2,'.','')?>:</strong> $<?=$model->hst_amount?></p>
            <?php
          }
           ?>
