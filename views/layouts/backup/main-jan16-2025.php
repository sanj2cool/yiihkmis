            ...
            <div class="col-9 pe-0 px-1">
              ...
              <form class="position-relative" data-bs-toggle="search" data-bs-display="static">
                  ...
                  <div class="input-group">
                      <input class="form-control search-input fuzzy-search form-control-sm rounded" id="search_by_part" type="search" placeholder="Search by item name..." aria-label="Search" />
