  ...
  <main class="main" id="top">
    ...
    <nav class="navbar navbar-top fixed-top navbar-expand" id="navbarDefault">
      <div class="collapse navbar-collapse justify-content-between">
        ...
        <div class="search-box navbar-top-search-box d-none d-lg-block d-sm-block w-lg-25 w-100 me-2" data-list=''>
          <form class="position-relative" data-bs-toggle="search" data-bs-display="static">
            <div class="input-group">
               <input class="form-control search-input fuzzy-search rounded-pill form-control-sm" id="search_by_part" type="search" placeholder="Search by item name..." aria-label="Search" />
            ...
            <div class="card position-relative border-0">
              ...
              <div class="overflow-auto scrollbar" style="height: 10rem;">
                <ul class="nav d-flex flex-column mb-2 pb-1">
                  ...
                  <li class="nav-item"><a class="nav-link px-3 d-block" href="<?=Url::to(['user/updatepassword'])?>"> <span class="me-2 text-body align-bottom" data-feather="settings"></span>Password Update</a></li>
...
<div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1" aria-labelledby="settings-offcanvas">
    ...
    <div class="setting-panel-item">
      ...
      <div class="row gx-2">
        <div class="col-6">
          ...
          <label class="btn d-block w-100 btn-navbar-style fs-9" for="navbar-style-default"> <img class="img-fluid img-prototype d-dark-none" src="design/assets/img/generic/default-light.png" alt="" /><img class="img-fluid img-prototype d-light-none" src="design/assets/img/generic/default-dark.png" alt="" /><span class="label-text d-dark-none"> Default</span><span class="label-text d-light-none">Default</span></label>
        </div>
        <div class="col-6">
          ...
          <label class="btn d-block w-100 btn-navbar-style fs-9" for="navbar-style-dark"> <img class="img-fluid img-prototype d-dark-none" src="design/assets/img/generic/vertical-darker.png" alt="" /><img class="img-fluid img-prototype d-light-none" src="design/assets/img/generic/vertical-lighter.png" alt="" /><span class="label-text d-dark-none"> Darker</span><span class="label-text d-light-none">Lighter</span></label>
        </div>
      </div>
    </div>
    ...
    <div class="setting-panel-item">
      ...
      <div class="row gx-2">
        ...
        <div class="col-6">
          ...
          <label class="btn d-inline-block btn-navbar-style fs-9" for="navbarTopDarker"> <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0" src="design/assets/img/generic/navbar-top-style-light.png" alt=""/><img class="img-fluid img-prototype d-light-none mb-0" src="design/assets/img/generic/top-style-lighter.png" alt=""/></span><span class="label-text d-dark-none">Darker</span><span class="label-text d-light-none">Lighter</span></label>
        </div>
      </div>
    </div>
  </div>
  ...
  $(document).ready(function(){
    ...
    $("#search_by_part").keyup(function(){
      ...
      if(search != ""){
        $.post("index.php?r=site/search-by-part",{search:search},function(r){
          console.log(r);
