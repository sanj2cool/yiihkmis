  ...
  <div class="card shadow rounded mt-2">
    <div class="card-body p-3">
      <div class="row">
        ...
        <div class="col-lg-3">
          <?= $form->field($model, 'purchase_status')->dropDownList($pstatusarr,['prompt'=>'Select']) ?>
        </div>
        <div class="col-lg-3">
          <?= $form->field($model, 'payment_status')->dropDownList($paymentstatusarr,['prompt'=>'Select']) ?>

        </div>
        <div class="col-lg-3">
          <?= $form->field($model, 'approved_by')->dropDownList($emparr,['prompt'=>'Select']) ?>
        </div>
        <div class="col-lg-3">
