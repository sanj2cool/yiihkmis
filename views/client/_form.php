        ...
        <div class="tab-pane fade show active" id="home" role="tabpanel">
          <div class="card shadow rounded mt-2">
            ...
            <div class="card-body p-3">
              ...
              <div class="row">
                <div class="col-lg-4">
                  <?= $form->field($model, 'status')->dropDownList([1=>"Active",2=>"Inactive",3=>"In Review"],['prompt' => 'Select','class'=>'form-select'])->label('Status<span class="text-danger">*</span>') ?>
                </div>
                <div class="col-lg-4">
          ...
          <div class="card shadow rounded mt-2">
            ...
            <div class="card-body p-3">
              ...
              <div class="row">
                <div class="col-lg-3">
                  <?= $form->field($model, 'fk_terms_id')->dropDownList($termsarr,['prompt'=>'Select','class'=>'form-select']) ?>
                </div>
                <div class="col-lg-3">
                  <?= $form->field($model, 'fk_preferred_payment_method_id')->dropDownList($prefpayarr,['prompt'=>'Select','class'=>'form-select']) ?>
                </div>
                <div class="col-lg-3">
                  <?= $form->field($model, 'credit_limit')->dropDownList($creditarr,['prompt'=>'Select','class'=>'form-select']) ?>
                </div>
                <div class="col-lg-3">
                  <?= $form->field($model, 'tier_id')->dropDownList($tierarr,['prompt'=>'Select','class'=>'form-select'])->label('Pricing Tier <sup><badge class="badge bg-danger">New</badge></sup>') ?>
                </div>
              </div>
