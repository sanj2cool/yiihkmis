    ...
    @page {
       ...
       <div id="msg">
           ...
           <div class="alert alert-outline-success d-flex align-items-center hidden" role="alert" id="success_msg">
             ...
             <p class="mb-0 flex-1">Printed labels removed successfully.</p>
      ...
      <div class="card-body p-3">
          <div class="row">
              ...
              <div class="col-lg-6 text-end">
                    <button type="button" class="btn btn-danger btn-sm hidden" id="btn_remove">Remove the Printed Labels from the List</button>
  ...
  $this->registerJs("
    ...
    function removeSelectedChoices() {
      // Remove selected choices
         ...
         fetch('index.php?r=site/get-labels')  // Replace with your actual endpoint
    ...
    $('#btn_remove').click(function(e){
      e.preventDefault();
       if (confirm('Are you sure you want to remove the printed labels?') == true) {
         ...
         $.post('index.php?r=site/remove-labels-from-list',{labels:selected_labels},function(r){
           // console.log(r);
           if(r == 'success'){
