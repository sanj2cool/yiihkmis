   ...
   <div class="card-header p-4 border-bottom border-300 bg-soft">
     <div class="row g-3 justify-content-between align-items-center">
       <div class="col-12 col-md">
         <h4 class="text-900 mb-0" data-anchor="data-anchor">Invoices</h4>
       </div>
       <div class="col col-md-auto">
         <a href="<?=Url::to(['site/invoice-create'])?>">
       <button type="button" name="button" class="btn btn-primary">Create Invoice
       </button>
       </a>
       </div>
     ...
     <div id="tableExample3" data-list="{&quot;valueNames&quot;:[&quot;name&quot;,&quot;email&quot;,&quot;age&quot;],&quot;page&quot;:10,&quot;pagination&quot;:true}">
       ...
       <div class="table-responsive">
         <table class="table table-striped table-sm fs--1 mb-0">
           <thead>
             <tr>
               <th class="sort border-top ps-3" data-sort="id">Act.</th>
               <th class="sort border-top" data-sort="id">Invoice #</th>
               <th class="sort border-top" data-sort="name">Customer</th>
               <th class="sort border-top" data-sort="address">Terms</th>
               <th class="sort border-top" data-sort="city">Invoice Date</th>
               <th class="sort border-top" data-sort="province">Due Date</th>
               <th class="sort border-top" data-sort="postal_code">Total Amount</th>
               <th class="sort border-top" data-sort="contact_person">Email Sent Status</th>
               <th class="sort border-top" data-sort="email">Invoice Status</th>
             </tr>
           </thead>
           <tbody class="list">
             <tr>
             ...
             <td class="align-middle ps-3 id">3645734</td>
             <td class="align-middle name">ABC Company</td>
             <td class="align-middle address">Net 30</td>
             <td class="align-middle city">11/05/2024</td>
             <td class="align-middle province">10/06/2024</td>
             <td class="align-middle postal_code">1034.90</td>
             <td class="align-middle contact_person">Not sent</td>
             <td class="align-middle contact_number">Not Paid</td>
           </tr>
           <tr>
             <td class="align-middle status">
               <i class="far fa-edit text-primary"></i>
             ...
             <td class="align-middle ps-3 id">8456845</td>
             <td class="align-middle name">123 Inc.</td>
             <td class="align-middle address">Net 15</td>
             <td class="align-middle city">04/05/2024</td>
             <td class="align-middle province">03/06/2024</td>
             <td class="align-middle postal_code">8887.00</td>
             <td class="align-middle contact_person">Sent</td>
             <td class="align-middle contact_number">Paid</td>
           </tr>
           <tr>
             <td class="align-middle status">
               <i class="far fa-edit text-primary"></i>
             ...
             <td class="align-middle postal_code">1034.90</td>
             <td class="align-middle contact_person">Sent</td>
             <td class="align-middle contact_number">Partially Paid</td>
           </tr>
           <tr>
             <td class="align-middle status">
               <i class="far fa-edit text-primary"></i>
