 ...
 <div class="card shadow-none border border-300 my-4" data-component-card="data-component-card">
   <div class="card-header p-4 border-bottom border-300 bg-soft">
     <div class="row g-3 justify-content-between align-items-center">
       <div class="col-12 col-md">
         <h4 class="text-900 mb-0" data-anchor="data-anchor">Purchase Order</h4>
       </div>
       <div class="col col-md-auto">
         <a href="<?=Url::to(['site/purchase-order-create'])?>">
       <button type="button" name="button" class="btn btn-primary">Create New Purchase Order
       </button>
       </a>
       </div>
   ...
   <div class="card-body p-4">
         ...
         <table class="table table-striped table-sm fs--1 mb-0">
           <thead>
             <tr>
               ...
               <th class="sort border-top ps-3" data-sort="id">PO Number.</th>
               <th class="sort border-top ps-3" data-sort="id">PO Date</th>
               <th class="sort border-top ps-3" data-sort="id">Vendor</th>
               <th class="sort border-top ps-3" data-sort="id">Total Amount</th>
               <th class="sort border-top" data-sort="date">Expected Delivery Date</th>
               <th class="sort border-top" data-sort="status">Received qty</th>
               <th class="sort border-top" data-sort="status">Status</th>
               <th class="sort border-top" data-sort="status">Payment Status</th>
     ...
     <tr>
       ...
       <td class="align-middle date">2024-08-02</td>
       <td class="align-middle">XYZ Industries</td>
       <td class="align-middle ps-3 id">$2,500.00</td>
       <td class="align-middle title">2024-08-12</td>
       <td class="align-middle">250</td>
       <td class="align-middle">Partially Received</td>
       <td class="align-middle">Partially Paid</td>
       <td class="align-middle">Jane Smith</td>
       <td class="align-middle">Pending shipment</td>
     </tr>
     <tr>
       <td class="align-middle status">
         <i class="far fa-edit text-primary"></i>
     ...
     <tr>
      ...
      <td class="align-middle title">2024-08-20</td>
      <td class="align-middle">300</td>
      <td class="align-middle">Partially Received</td>
      <td class="align-middle">Partially Paid</td>
      <td class="align-middle">Olivia Davis</td>
      <td class="align-middle">Backorder expected</td>
    </tr>
    <tr>
      <td class="align-middle status">
        <i class="far fa-edit text-primary"></i>
    ...
    <tr>
      ...
      <td class="align-middle title">2024-08-25</td>
      <td class="align-middle">220</td>
      <td class="align-middle">Received</td>
      <td class="align-middle">Paid</td>
      <td class="align-middle">Sophia Miller</td>
      <td class="align-middle">Order completed</td>
    </tr>
    <tr>
      <td class="align-middle status">
        <i class="far fa-edit text-primary"></i>
    ...
    <tr>
      ...
      <td class="align-middle title">2024-09-01</td>
      <td class="align-middle">280</td>
      <td class="align-middle">Partially Received</td>
      <td class="align-middle">Partially Paid</td>
      <td class="align-middle">Charlotte Taylor</td>
      <td class="align-middle">Additional items expected</td>
    </tr>
    <tr>
      <td class="align-middle status">
        <i class="far fa-edit text-primary"></i>
      ...
      <td class="align-middle date">2024-08-10</td>
      ...
      <td class="align-middle">Check specifications</td>
    </tr>
