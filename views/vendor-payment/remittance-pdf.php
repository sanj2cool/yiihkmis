    ...
    <table width="100%" style="valign:top;">
        <tr>
          <td width="20%" valign="top">
                <?php if (!empty($bill_logo) && file_exists('/var/www/vhosts/hkmis.ca/httpdocs/web/ownercompany-logo/'.$bill_logo)): ?>
                    <img src="<?= '/var/www/vhosts/hkmis.ca/httpdocs/web/ownercompany-logo/'.$bill_logo ?>" style="height:72px;">
                <?php endif; ?>
            </td>
...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?= Html::encode($row->invoice->purchase_invoice_no) ?></td>
