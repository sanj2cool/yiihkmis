            ...
            <div class="card-body p-3">
              <div class="row">
                ...
                <div class="col-lg-3">
                  ...
                  <select class="form-control" name="brand[]" id="brands" multiple required>
                ...
                <div class="col-lg-3">
                  <?= $form->field($model, 'fk_category_id')->dropDownList($categoryList,['prompt'=>'Select','encode'=>false])->label('Category<span class="text-danger">*</span>') ?>
                </div>
                <div class="col-lg-2">
            ...
            <div class="card-body p-3">
              <div class="row">
                <div class="col-lg-2 mb-2">
                  <?= $form->field($model, 'default_tier')->dropDownList([1=>"Tier 1",2=>"Tier 2",3=>"Tier 3",4=>"Tier 4",5=>"Tier 5",6=>"Tier 6",7=>"Tier 7",8=>"Tier 8",9=>"Tier 9",10=>"Tier 10",11=>"Tier 11"],['prompt'=>'Select'])->label('Default Tier <sup><span class="badge bg-danger">New</span></sup>') ?>
                </div>
                <div class="col-lg-2 mb-2">
              ...
              <div class="row">
                <div class="col-lg-2 mb-2">
                  <?= $form->field($model, 'tier_6_markup')->textInput(['class'=>'floatNumberField form-control','onkeyup'=>'checkDec(this);'])->label('Tier 6 Markup % <sup><span class="badge bg-danger">New</span></sup>') ?>
                </div>
                <div class="col-lg-2 mb-2">
                  <?= $form->field($model, 'tier_7_markup')->textInput(['class'=>'floatNumberField form-control','onkeyup'=>'checkDec(this);'])->label('Tier 7 Markup % <sup><span class="badge bg-danger">New</span></sup>') ?>
                </div>
                <div class="col-lg-2 mb-2">
                  <?= $form->field($model, 'tier_8_markup')->textInput(['class'=>'floatNumberField form-control','onkeyup'=>'checkDec(this);'])->label('Tier 8 Markup % <sup><span class="badge bg-danger">New</span></sup>') ?>
                </div>
                <div class="col-lg-2 mb-2">
                  <?= $form->field($model, 'tier_9_markup')->textInput(['class'=>'floatNumberField form-control','onkeyup'=>'checkDec(this);'])->label('Tier 9 Markup % <sup><span class="badge bg-danger">New</span></sup>') ?>
                </div>
                <div class="col-lg-2 mb-2">
                  <?= $form->field($model, 'tier_10_markup')->textInput(['class'=>'floatNumberField form-control','onkeyup'=>'checkDec(this);'])->label('Tier 10 Markup % <sup><span class="badge bg-danger">New</span></sup>') ?>
                </div>
                <div class="col-lg-2 mb-2">
                  <?= $form->field($model, 'tier_11_markup')->textInput(['class'=>'floatNumberField form-control','onkeyup'=>'checkDec(this);'])->label('Tier 11 Markup % <sup><span class="badge bg-danger">New</span></sup>') ?>
                </div>
              </div>
...
foreach($allprods as $p){
  ...
  // Initialize Choices.js on a specific select element by its ID
  new Choices("#tblproduct-fk_category_id", {
