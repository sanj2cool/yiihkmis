      ...
      <div class="tab-pane fade show active" id="home" role="tabpanel">
           ...
           <div class="row g-3 justify-content-between align-items-center">
            ...
            <div class="card-body p-3">
              <div class="row">
                ...
                <div class="col-lg-3">
                  <label for="">Brand<span class="text-danger">*</span><sup><badge class="badge bg-danger">New</badge></sup></label>
                ...
                <div class="col-lg-3">
                  <?= $form->field($model, 'fk_category_id')->dropDownList($categoryList,['prompt'=>'Select','encode'=>false]) ?>
                </div>
                <div class="col-lg-2">
        ...
        <div class="card shadow rounded mt-2">
          <div class="card-header p-3 border-bottom border-300 bg-success-subtle">
           <div class="row g-3 justify-content-between align-items-center">
             <div class="col-12 col-md">
               <h4 class="text-900 mb-0" data-anchor="data-anchor" id="pricing-details">Markup Details <sup><badge class="badge bg-danger">New</badge></sup></h4>
             </div>
           </div>
         </div>
            <div class="card-body p-3">
              <div class="row">
                ...
                <div class="col-lg-2">
                  <?= $form->field($model, 'tier_4_markup')->textInput(['class'=>'floatNumberField form-control','onkeyup'=>'checkDec(this);'])->label('Tier 4 Markup %age <sup><span class="badge bg-danger">New</span></sup>') ?>
                </div>
                <div class="col-lg-2">
                  <?= $form->field($model, 'tier_5_markup')->textInput(['class'=>'floatNumberField form-control','onkeyup'=>'checkDec(this);'])->label('Tier 5 Markup %age <sup><span class="badge bg-danger">New</span></sup>') ?>
                </div>
