        ...
        'columns' => [
            ...
            [
              ...
              'urlCreator' => function ($action, $model, $key, $index) {
                if ($action === 'edit') {
                  $url ='index.php?r=product/update&id='.$model->id;
                  return $url;
                }
                if ($action === 'view') {
                ...
                if ($action === 'delete') {
                  $url ='index.php?r=product/delete&id='.$model->id;
                  return $url;
                }
              }
            ],
          ...
          [
            ...
            [
              ...
              'filter' => Html::activeDropDownList($searchModel, 'fk_category_id', $categoryList,['class'=>'form-control','prompt' => 'Select', 'encode' => false]),
            ],
            'sku',
            [
