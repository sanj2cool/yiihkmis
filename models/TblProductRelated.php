 ...
 * @property int $fk_related_product_id
 * @property string $ip
 ...
 */
class TblProductRelated extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['fk_product_id', 'fk_related_product_id'], 'required'],
            [['fk_product_id', 'fk_related_product_id', 'status', 'crt_by', 'mod_by'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'fk_related_product_id' => 'Fk Related Product ID',
            'ip' => 'Ip',
            'status' => 'Status',
            'crt_by' => 'Crt By',
            'mod_by' => 'Mod By',
