 ...
 */
class TblInvoiceItem extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['fk_invoice_id','quantity', 'unit_price', 'total_price'], 'required'],
            [['fk_invoice_id', 'type', 'fk_product_id', 'status', 'crt_by', 'mod_by','tier_id'], 'integer'],
