...
/**
 * This is the model class for table "tbl_client_receipt_image".
 *
 * @property int $id
 * @property int $fk_receipt_id
 ...
 */
class TblClientReceiptImage extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'tbl_client_receipt_image';
    }
    ...
    {
        return [
            [['fk_receipt_id'], 'required'],
            [['fk_receipt_id', 'status', 'crt_by', 'mod_by'], 'integer'],
