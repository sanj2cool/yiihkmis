...
/**
 * This is the model class for table "tbl_printed_labels".
 *
 * @property int $id
 * @property int $fk_bin_locations_id
 * @property string $ip
 ...
 */
class TblPrintedLabels extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['fk_bin_locations_id'], 'required'],
            [['fk_bin_locations_id', 'status'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'fk_bin_locations_id' => 'Fk Bin Locations ID',
            'ip' => 'Ip',
            'status' => 'Status',
            'crt_by' => 'Crt By',
            'mod_by' => 'Mod By',
