...
/**
 * This is the model class for table "tbl_invoice_sent_log".
 *
 * @property int $id
 ...
 */
class TblInvoiceSentLog extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['fk_invoice_id'], 'required'],
            [['fk_invoice_id', 'status', 'crt_by', 'mod_by'], 'integer'],
