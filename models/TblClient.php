...
class TblClient extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['company_name', 'email','status'], 'required'],
            [['fk_terms_id', 'fk_preferred_payment_method_id', 'credit_limit', 'status', 'crt_by', 'mod_by','tier_id','fk_location_id'], 'integer'],
            [['notes'], 'string'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'country' => 'Country',
            'fk_terms_id' => 'Terms',
            'fk_preferred_payment_method_id' => 'Preferred Payment Method',
