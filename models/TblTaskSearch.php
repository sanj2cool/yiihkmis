...
/**
 * TblTaskSearch represents the model behind the search form of `app\models\TblTask`.
 */
class TblTaskSearch extends TblTask
{
    ...
    {
        return [
            [['id', 'assigned_to', 'status_id', 'crt_by', 'status', 'mod_by','fk_location_id'], 'integer'],
            [['title', 'description', 'due_date', 'time', 'crt_time', 'ip', 'mod_time'], 'safe'],
        ];
    }
