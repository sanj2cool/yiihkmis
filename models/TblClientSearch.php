...
/**
 * TblClientSearch represents the model behind the search form of `app\models\TblClient`.
 */
class TblClientSearch extends TblClient
{
    ...
    {
        return [
            [['id', 'fk_terms_id', 'fk_preferred_payment_method_id', 'credit_limit', 'status', 'crt_by', 'mod_by','tier_id','fk_location_id'], 'integer'],
            [['company_name', 'contact_name', 'contact_title', 'email', 'phone', 'address', 'city', 'state', 'postal_code', 'country', 'notes', 'ip', 'crt_time', 'mod_time'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'fk_preferred_payment_method_id' => $this->fk_preferred_payment_method_id,
