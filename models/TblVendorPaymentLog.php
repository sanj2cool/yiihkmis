 ...
 */
class TblVendorPaymentLog extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['fk_vendor_payment_id'], 'required'],
            [['fk_vendor_payment_id', 'status', 'crt_by', 'mod_by'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'fk_vendor_payment_id' => 'Fk Client ID',
