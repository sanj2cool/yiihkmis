...
/**
 * This is the model class for table "tbl_report_favorite".
 *
 * @property int $id
 ...
 */
class TblReportFavorite extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['fk_report_id', 'fk_user_id', 'status', 'crt_by', 'mod_by'], 'integer'],
