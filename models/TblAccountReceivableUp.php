 ...
 */
class TblAccountReceivableUp extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['fk_invoice_id', 'amount_received', 'ar_date', 'fk_payment_method_id'], 'required'],
            [['fk_invoice_id', 'fk_payment_method_id', 'status','fk_bill_from_id'], 'integer'],
