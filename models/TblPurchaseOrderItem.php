 ...
 */
class TblPurchaseOrderItem extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['fk_purchase_order_id', 'quantity', 'unit_price', 'total_price'], 'required'],
            [['fk_purchase_order_id', 'fk_product_id', 'quantity', 'status', 'crt_by', 'mod_by'], 'integer'],
...
{
    return $this->hasOne(TblPurchaseOrder::class, ['id' => 'fk_purchase_order_id']);
}
}
