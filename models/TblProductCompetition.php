...
/**
 * This is the model class for table "tbl_product_competition".
 *
 * @property int $id
 ...
 */
class TblProductCompetition extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'tbl_product_competition';
    }
    ...
    {
        return [
            [['fk_product_id', 'seller_name', 'selling_price'], 'required'],
            [['fk_product_id', 'status', 'crt_by', 'mod_by'], 'integer'],
