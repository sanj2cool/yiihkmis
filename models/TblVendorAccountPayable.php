 ...
 */
class TblVendorAccountPayable extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'tbl_vendor_account_payable';
    }
    ...
    {
        return [
            [['fk_vendor_invoice_id', 'amount_received', 'ar_date', 'fk_payment_method_id'], 'required'],
            [['fk_vendor_invoice_id', 'fk_payment_method_id', 'status','fk_vendor_payment_id'], 'integer'],
    ...
    {
        return $this->hasOne(TblVendorInvoice::class, ['id' => 'fk_vendor_invoice_id']);
    }
    public function getInvoice()
    {
        return $this->hasOne(TblVendorInvoice::className(), ['id' => 'fk_vendor_invoice_id']);
    }
