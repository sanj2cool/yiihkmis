 ...
 */
class TblVendorPaymentFile extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'tbl_vendor_payment_file';
    }
    ...
    {
        return [
            [['fk_vendor_payment_id', 'file_url'], 'required'],
            [['fk_vendor_payment_id', 'status'], 'integer'],
            [['notes'], 'string'],
