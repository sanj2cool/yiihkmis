 ...
 */
class TblProductAssignedCategory extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'tbl_product_assigned_category';
    }
    ...
    {
        return [
            [['fk_product_id', 'fk_category_id'], 'required'],
            [['fk_product_id', 'fk_category_id', 'status', 'crt_by', 'mod_by'], 'integer'],
