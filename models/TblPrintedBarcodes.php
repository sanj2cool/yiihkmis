...
/**
 * This is the model class for table "tbl_printed_barcodes".
 *
 * @property int $id
 ...
 */
class TblPrintedBarcodes extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
