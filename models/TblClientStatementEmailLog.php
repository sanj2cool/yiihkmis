 ...
 */
class TblClientStatementEmailLog extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'tbl_client_statement_email_log';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['fk_client_id', 'status', 'crt_by', 'mod_by','fk_ownership_id'], 'integer'],
