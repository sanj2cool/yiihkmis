...
/**
* TblAccountReceivableSearch represents the model behind the search form of `app\models\TblAccountReceivable`.
*/
class TblAccountReceivableSearch extends TblAccountReceivable
{
  public $invoice;
  public $client;
  /**
  ...
  */
  ...
  {
    return [
      [['id', 'fk_invoice_id', 'fk_payment_method_id', 'status','fk_bill_from_id'], 'integer'],
  ...
  */
  public function search($params)
  {
    ...
    $query = TblAccountReceivable::find()
    ->where('tbl_account_receivable.status != 0')
    ->andWhere('fk_invoice_id in (select id from tbl_invoice where fk_bill_from_id = '.$user_company.')');
    ...
    $dataProvider->setSort([
      ...
      'attributes' => [
        ...
        'is_bad_debt' => [
          'asc' => ['is_bad_debt' => SORT_ASC],
          'desc' => ['is_bad_debt' => SORT_DESC],
          'label' => 'Bad Debt'
        ],
        'client' => [
        ...
        'invoice' => [
          'asc' => ['tbl_invoice.invoice_number' => SORT_ASC],
          'desc' => ['tbl_invoice.invoice_number' => SORT_DESC],
          'label' => 'Invoice'
        ]
      ]
    ]);
    ...
    $query->andFilterWhere([
      ...
      'tbl_account_receivable.fk_bill_from_id' => $this->fk_bill_from_id,
      'status' => $this->status,
    ...
    $query->andFilterWhere(['like', 'tbl_invoice.invoice_number', $this->invoice]);
